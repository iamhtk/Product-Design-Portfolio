...
export function FriendsPage() {
  const friends = [
    ...
    { number: '02', name: 'Bob Royce', role: 'CEO/Co-Founder', company: 'The Understanding Group (TUG)', link: 'https://understandinggroup.com/bob-royce' },
    { number: '03', name: 'Charles Severance (Dr. Chuck)', role: 'Clinical Associate Professor', company: 'University of Michigan', link: 'https://www.dr-chuck.com/' },
    ...
    { number: '15', name: 'Huiran Yi', role: 'PhD Candidate', company: 'University of Michigan, School of Information', link: 'https://www.huiranyi.com/' },
    { number: '16', name: 'Iris Yuning Ye', role: 'Product Manager', company: 'Microsoft', link: 'https://www.linkedin.com/in/irisyn-ye/' },
    { number: '17', name: 'James (Jim) Rampton', role: 'Lecturer III in Information', company: 'University of Michigan, School of Information', link: 'https://www.linkedin.com/in/jim-rampton-26a95440' },
    { number: '18', name: 'Jenny Ye', role: 'Data Engineer II', company: 'The Washington Post', link: 'https://www.linkedin.com/in/hjennye' },
    { number: '19', name: 'Jessica Allen', role: 'Instructional Designer', company: 'Empower Accessibility', link: 'https://www.linkedin.com/in/jessicaallen531' },
    { number: '20', name: 'Joe Elmendorf', role: 'Co-Founder', company: 'Maps and Mirror', link: 'https://www.mapsandmirror.com/' },
    { number: '21', name: 'Kristin Isaac', role: 'CEO and Co-Founder', company: 'Strudel', link: 'https://www.linkedin.com/in/kristinisaac' },
    { number: '22', name: 'Linda Huber', role: 'PhD candidate', company: 'University of Michigan, School of Information', link: 'https://puellaludens.com/' },
    { number: '23', name: 'Luke Bratic', role: 'Product Designer', company: 'eNGINE', link: 'https://www.linkedin.com/in/lbratic' },
    { number: '24', name: 'Michael Bogart', role: 'Student', company: 'University of Michigan, School of Information', link: '#' },
    { number: '25', name: 'Namita Nisal', role: 'Senior Product Designer', company: 'Cisco-Meraki', link: 'https://namitanisal.com/' },
    { number: '26', name: 'Nancy Weatherford', role: 'Operational and Financial Manager', company: 'The Understanding Group (TUG)', link: 'https://understandinggroup.com/nancy-weatherford' },
    { number: '27', name: 'Natalia Chernysheva', role: 'Teaching Associate Professor of Russian', company: 'The University of North Carolina at Chapel Hill', link: 'https://gsll.unc.edu/chernysheva-3/' },
    { number: '28', name: 'Nicola Antonazzo', role: 'Senior Product Designer', company: 'Microsoft', link: 'https://antonazzonico.la/' },
    { number: '29', name: 'Pankaj Paneri', role: 'Product Manager', company: 'CWPC @ CrowdDoing', link: 'https://www.linkedin.com/in/pankaj-paneri' },
    { number: '30', name: 'Percy Long', role: 'Product Designer', company: 'Innovation AI', link: 'https://www.linkedin.com/in/baixipercylong' },
    { number: '31', name: 'Phil Mendez', role: 'UX Researcher', company: 'Cisco', link: 'https://www.linkedin.com/in/philmendez' },
    { number: '32', name: 'Rosalie Morrissey', role: 'Information Resources Associate Supervisor', company: 'University of Michigan, Michigan Law', link: 'https://www.rosaliemorrissey.com/' },
    { number: '33', name: 'Shai Rubin', role: 'Co-Founder', company: 'Strudel', link: 'https://www.linkedin.com/in/shairubin/' },
    { number: '34', name: 'Shubhi Singla', role: 'Program Manager', company: 'CWPC @ CrowdDoing', link: 'https://www.linkedin.com/in/shubhisingla' },
    { number: '35', name: 'Whitney Speck', role: 'Designer', company: 'JLR', link: 'https://www.linkedin.com/in/whitney-speck' },
    { number: '36', name: 'Xi Zhang', role: 'Product Designer', company: 'Crigloo', link: 'https://www.linkedin.com/in/xizh' },
    { number: '37', name: 'Jian Jet Zhu', role: 'Director of Research', company: 'Polaris Wireless', link: 'https://www.linkedin.com/in/jetzhu/' },
    { number: '38', name: 'Roman Dobrik', role: 'CTO and Founder', company: 'Exilor', link: 'https://www.linkedin.com/in/rdobrik/' },
    { number: '39', name: 'Calista Chen', role: 'Founder', company: 'frmnt', link: 'https://www.linkedin.com/in/calista-chen/' },
    { number: '40', name: 'Mahit Munakala', role: 'Sr Product Designer', company: 'Cisco AI', link: 'https://www.linkedin.com/in/mahitmunakala/' },
    { number: '41', name: 'Ella Jackson', role: 'UX Design', company: 'Xometry', link: 'https://www.linkedin.com/in/ellafjackson/' },
    { number: '42', name: 'Manav Singh', role: 'Software Engineer', company: 'Abbott', link: 'https://www.linkedin.com/in/manavpavitrasingh/' },
    { number: '43', name: 'Manu Mukerji', role: 'Global Head of Infrastructure, Apple WPC (Wallet, Payments & Commerce)', company: 'Apple', link: 'https://www.linkedin.com/in/manumukerji/' },
    { number: '44', name: 'Tianhao Zhou', role: 'Senior Software Engineer, Gemini Model Optimization', company: 'Google', link: 'https://www.linkedin.com/in/tianhaoz/' },
    { number: '45', name: 'Dave Anderson', role: 'COO', company: 'Eragon', link: 'https://www.linkedin.com/in/davidand21/' },
    { number: '46', name: 'Keri Fullwood', role: 'Head of UX Design, Air India US (Digital & Product)', company: 'TCS', link: 'https://www.linkedin.com/in/kerif/' },
    { number: '47', name: 'Ed C. Garcia', role: 'Engineering Program Manager', company: 'Apple', link: 'https://www.linkedin.com/in/edcgarcia/' },
    { number: '48', name: 'Blake Bennett', role: 'Lead Mixed Methods UX Researcher for Gemini AI', company: 'Google DeepMind', link: 'https://www.linkedin.com/in/blaketbennett/' },
    { number: '49', name: 'Suzanne Bayles', role: 'AI Consultant', company: 'VPK AI | Vision & Purpose Keyed A', link: '#' },
    { number: '50', name: 'Charles Merriam', role: 'Founder', company: 'Evo Reach', link: '#' },
    { number: '51', name: 'Jeffrey Cooper', role: 'Chief AI & Systems Architect', company: 'Prime Health Technologies', link: 'https://www.linkedin.com/in/jeffrey-cooper-iot/' },
    { number: '52', name: 'Dmitry Sheremet', role: 'Sr. Software Engineer', company: 'Roku Inc.', link: 'https://www.linkedin.com/in/dmitry-sheremet/?locale=en' },
    { number: '53', name: 'Jason Zhao', role: 'Software Engineer', company: 'Samsung', link: 'https://www.linkedin.com/in/jason-zhao-8930aa17b/' },
    { number: '54', name: 'Lonnie Chrisman', role: 'Chief Technology Officer', company: 'Lumina Decision Systems', link: 'https://www.linkedin.com/in/lonnie-chrisman-1b13b9/' },
    { number: '55', name: 'Mark Evans', role: 'Founder & Operator, Proving Ground (Venture Platform & Ecosystem Leadership)', company: 'Proving Ground', link: 'https://www.linkedin.com/in/markevans101/' },
    { number: '56', name: 'F. Michael Kunz', role: 'Sr. Data Scientist, Apple Ads Platforms, Customer Team', company: 'Apple', link: 'https://www.linkedin.com/in/f-michael-kunz/' },
    { number: '57', name: 'Kshitij Garg – KG', role: 'Chief Product Officer', company: 'Think Future Technologies', link: 'https://www.linkedin.com/in/kshitij-garg21/' },
    { number: '58', name: 'Dawa Riley', role: 'Director of Product Design', company: 'Sapiom', link: 'https://www.linkedin.com/in/dawariley/' },
