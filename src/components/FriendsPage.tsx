...
export function FriendsPage() {
  const friends = [
    ...
    { number: '04', name: 'Charles Severance (Dr. Chuck)', role: 'Clinical Associate Professor', company: 'University of Michigan', link: 'https://www.dr-chuck.com/' },
    { number: '05', name: 'Claudia Brenner', role: 'CEO', company: 'CWPC @ CrowdDoing', link: 'https://www.linkedin.com/in/claudia-brenner' },
    { number: '06', name: 'Dan Heck', role: 'Chief AI Ethicist', company: 'The Understanding Group (TUG)', link: 'https://understandinggroup.com/dan-heck' },
    { number: '07', name: 'Dan Klyn', role: 'Co-Founder', company: 'The Understanding Group (TUG)', link: 'https://understandinggroup.com/dan-klyn' },
    { number: '08', name: 'Daniel O Neil', role: 'Analyst', company: 'The Understanding Group (TUG)', link: 'https://understandinggroup.com/daniel-oneil' },
    { number: '09', name: 'Dhanush Nandish', role: 'UX Designer', company: 'CWPC @ CrowdDoing', link: 'https://in.linkedin.com/in/dhanush-nandish-07307125b' },
    { number: '10', name: 'Elena Godin', role: 'Teaching Professor and Lecturer IV', company: 'University of Michigan, School of Information', link: 'https://www.linkedin.com/in/elenagodin' },
    { number: '11', name: 'Emerald Paul', role: 'Business Analyst', company: 'CWPC @ CrowdDoing', link: 'https://www.linkedin.com/in/emerald-paul-365677b/' },
    { number: '12', name: 'Emily Claflin', role: 'Information Architect', company: 'The Understanding Group (TUG)', link: 'https://understandinggroup.com/emily-claflin' },
    { number: '13', name: 'Esty Zilberman', role: 'Founder', company: 'Build it Real', link: 'https://www.estyzilberman.com/' },
    { number: '14', name: 'Grant Carmichael', role: 'Information Architect', company: 'The Understanding Group (TUG)', link: 'https://understandinggroup.com/grant-carmichael' },
    { number: '15', name: 'Haripriya Vijayan', role: 'Product Manager', company: 'CWPC @ CrowdDoing', link: 'https://www.linkedin.com/in/haripriyavijayan' },
    { number: '16', name: 'Huiran Yi', role: 'PhD Candidate', company: 'University of Michigan, School of Information', link: 'https://www.huiranyi.com/' },
    { number: '17', name: 'Iris Yuning Ye', role: 'Product Manager', company: 'Microsoft', link: 'https://www.linkedin.com/in/irisyn-ye/' },
    { number: '18', name: 'James (Jim) Rampton', role: 'Lecturer III in Information', company: 'University of Michigan, School of Information', link: 'https://www.linkedin.com/in/jim-rampton-26a95440' },
    { number: '19', name: 'Jenny Ye', role: 'Data Engineer II', company: 'The Washington Post', link: 'https://www.linkedin.com/in/hjennye' },
    { number: '20', name: 'Jessica Allen', role: 'Instructional Designer', company: 'Empower Accessibility', link: 'https://www.linkedin.com/in/jessicaallen531' },
    { number: '21', name: 'Joe Elmendorf', role: 'Co-Founder', company: 'Maps and Mirror', link: 'https://www.mapsandmirror.com/' },
    { number: '22', name: 'Kristin Isaac', role: 'CEO and Co-Founder', company: 'Strudel', link: 'https://www.linkedin.com/in/kristinisaac' },
    { number: '23', name: 'Linda Huber', role: 'PhD candidate', company: 'University of Michigan, School of Information', link: 'https://puellaludens.com/' },
    { number: '24', name: 'Luke Bratic', role: 'Product Designer', company: 'eNGINE', link: 'https://www.linkedin.com/in/lbratic' },
    { number: '25', name: 'Michael Bogart', role: 'Student', company: 'University of Michigan, School of Information', link: '#' },
    { number: '26', name: 'Namita Nisal', role: 'Senior Product Designer', company: 'Cisco-Meraki', link: 'https://namitanisal.com/' },
    { number: '27', name: 'Nancy Weatherford', role: 'Operational and Financial Manager', company: 'The Understanding Group (TUG)', link: 'https://understandinggroup.com/nancy-weatherford' },
    { number: '28', name: 'Natalia Chernysheva', role: 'Teaching Associate Professor of Russian', company: 'The University of North Carolina at Chapel Hill', link: 'https://gsll.unc.edu/chernysheva-3/' },
    { number: '29', name: 'Nicola Antonazzo', role: 'Senior Product Designer', company: 'Microsoft', link: 'https://antonazzonico.la/' },
    { number: '30', name: 'Pankaj Paneri', role: 'Product Manager', company: 'CWPC @ CrowdDoing', link: 'https://www.linkedin.com/in/pankaj-paneri' },
    { number: '31', name: 'Percy Long', role: 'Product Designer', company: 'Innovation AI', link: 'https://www.linkedin.com/in/baixipercylong' },
    { number: '32', name: 'Phil Mendez', role: 'UX Researcher', company: 'Cisco', link: 'https://www.linkedin.com/in/philmendez' },
    { number: '33', name: 'Rosalie Morrissey', role: 'Information Resources Associate Supervisor', company: 'University of Michigan, Michigan Law', link: 'https://www.rosaliemorrissey.com/' },
    { number: '34', name: 'Shai Rubin', role: 'Co-Founder', company: 'Strudel', link: 'https://www.linkedin.com/in/shairubin/' },
    { number: '35', name: 'Shubhi Singla', role: 'Program Manager', company: 'CWPC @ CrowdDoing', link: 'https://www.linkedin.com/in/shubhisingla' },
    { number: '36', name: 'Whitney Speck', role: 'Designer', company: 'JLR', link: 'https://www.linkedin.com/in/whitney-speck' },
    { number: '37', name: 'Xi Zhang', role: 'Product Designer', company: 'Crigloo', link: 'https://www.linkedin.com/in/xizh' },
