...
export function FintechProject({ onBack }: FintechProjectProps) {
  ...
  const blocks: ContentBlock[] = [
    { type: 'text', header: 'UNDERSTANDING BUSINESS NEEDS', content: 'Through interviews with 100+ businesses, we learned that users needed quick answers to specific questions rather than comprehensive reports. They wanted insights, not just data.' },
    { type: 'image', src: 'https://images.unsplash.com/photo-1533234944761-2f5337579079?w=1200&q=80' },
    { type: 'text', header: 'INFORMATION ARCHITECTURE', content: 'We restructured the dashboard around key business questions: How much money am I making? Where is it coming from? What trends should I know about? This question-first approach guided the entire design.' },
    { type: 'image', src: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=1200&q=80' },
    { type: 'text', header: 'DESIGN SYSTEM', content: "We created a flexible component library that could scale across Stripe's entire product suite. Every chart, table, and metric followed consistent patterns while remaining contextually relevant." },
    { type: 'colors', colors: ['#635BFF', '#8580FF', '#A8A5FF', '#CACAFF'] },
  ];
