...
const CURRENT_PROJECT_ID = 'WeddingBliss';

interface WeddingBlissProjectProps {
  onBack: () => void;
...
export function WeddingBlissProject({ onBack, onProjectClick }: WeddingBlissProjectProps) {
